      ...
      <Modal
        ...
        <View style={styles.list_down_a}>
            ...
            <View style={{flexDirection:'column'}}>
              ...
              <TouchableOpacity onPress={()=>_this.check()}>
                <View style={{flexDirection:'row',alignItems:'center',marginTop:15,justifyContent:'center'}}>
                  {_this.state.check?
                  <Image style={{width:13,height:13}} source={require('../../images/address_a.png')}></Image>:
                  <Image style={{width:13,height:13}} source={require('../../images/address_b.png')}></Image>
                }
                  <Text style={{marginLeft:5,color:'#999999'}}>单位结算</Text>
                </View>
              </TouchableOpacity>
              <TouchableOpacity style={{alignItems:'center',marginTop:15}} onPress={()=>_props.toPayModal()}>
