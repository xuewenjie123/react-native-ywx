...
import { StatusBar,View,DeviceEventEmitter, Text,Image, ScrollView, TouchableOpacity, ToastAndroid, RefreshControl,InteractionManager,ListView} from 'react-native';
var styles =require('./styles');
import NavigatorTopBar from './../../components/NavigatorTopBar';
import NavWait from '../../components/common/NavWait'
import { width, height } from '../../components/common/Dimensions'
import {getsuggestionList} from '../../services/workList';
...
// ];
export default class SuggestWorkDetail extends Component {
  ...
  componentDidMount(){
    this.subscription=DeviceEventEmitter.addListener("changeSuggestWorkDetail",function(){
        _this.setState({
          reset:true
        })
      getsuggestionList({page:1,status:_state.types},_this.getRepairListSucc,_this.getRepairListFail)
     })
  ...
  getsuggestionList({page:1,status:type},_this.getRepairListSucc,_this.getRepairListFail)
  }
  onEndReached(){
  ...
  _renderRow(list,sectionID,rowID){
    return(
      <TouchableOpacity style={styles.list_a} onPress={()=>_navigator.navigate("MySuggestDetail",{code:list.code})} key={rowID}>
