...
export default class MyActivity extends Component {
  ...
  componentDidMount(){
    activitylist({page:1},_this.getActivityList,_this.getActivityListFail)
      // InteractionManager.runAfterInteractions(() => {
      // });
  }
  getActivityList(result){
  ...
  onEndReached(){
    ...
    if(_state.page*_state.size<_state.total && !_state.load){
      ...
      activitylist({page:1,status:_state.types},_this.getActivityList,_this.getActivityListFail)
    }
  }
