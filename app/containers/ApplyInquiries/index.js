...
import {positionList} from '../../services/MyCompany'
 ...
 import { connect } from 'react-redux';
  @connect(({ app }) => ({ ...app }))
export default class ApplyInquiries extends Component {
  constructor(props) {
    super(props);
    this.state = {
      complexAddress:"",
  ...
  repairAction(){
    var resultFu = function(response){
       if(response.success){
          _navigator.navigate("ApplySuccess",{router:"ApplyInquiries"})
      }else{
      ...
      if(!_this.state.complexAddress){
        ...
        createServer({name:_state.name,sex:_state.sex,phone:_state.tel,workOrderVos:[
          {files:_state.imageData,type:"INQUIRIES",locationId:_state.locationId,
