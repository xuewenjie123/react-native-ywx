...
export default class AllComplaint extends Component {
  ...
  componentDidMount(){
      ...
      //   })
        InteractionManager.runAfterInteractions(() => {
          getEvaluateList({page:1,evaluateType:2,personId:_state.personId,
  ...
  getRepairListFail(){
    ...
    onEndReached(){
      ...
      if(_state.page*_state.size<_state.total && !_state.load){
        ...
        getEvaluateList({page:_state.page+1,evaluateType:2,personId:_state.personId,
                        dataCode:_state.dataCode,
                        isFormMajorOrProperty:_state.isFormMajorOrProperty,
                        pageSize:_state.pageSize},_this.getRepairListSucc,_this.getRepairListFail)
      }
    ...
    return(
      <View key={rowID}>
          ...
          <View style={styles.itemevaluate} >
            ...
            <View style={{width:width-30}}><Text numberOfLines={2} style={styles.text}>{list.description}</Text></View>
          </View>
      </View>
    )
  }
