...
//  chart 完整的图表，如折线图，饼图
// axis 指教坐标系中的一个坐标轴 坐标轴可分为类目型 数值型  或时间型
// xAxis 指教坐标系横轴 通常默认为类目型
// yAxis 纵轴  默认数值型
// legend 图例 表述数据和图形的关联
//dataRange 值域选择
//dataZoom 数据区域缩放
//roamController 缩放漫游组件搭配地图使用
//toolbox  辅助工具箱、辅助功能 如添加标线
//tooltip  气泡提示框
//timeline  时间轴 常用于表现 同一系列数据在时间维度上的多份数据
//series  数据系列一个图标可能包含多个系列，每一个系列可能包含多个数据
...
import area from '../constant/area.json';
