...
import {votelist} from '../../services/myDetail';
...
export default class Activity extends Component {
  ...
  componentDidMount(){
      votelist({page:1},_this.voteList,_this.voteListFail)
  ...
  onEndReached(){
    ...
    if(_state.page*_state.size<_state.total && !_state.load){
      ...
      votelist({page:_this.state.page+1},_this.voteList,_this.voteListFail)
    }
  }
    ...
    <TouchableOpacity onPress={()=>_navigator.navigate("VoteResult",{datas:list})}>
      <View style={styles.list_a}>
          ...
          <View style={styles.list_down}>
              ...
              <Text style={styles.list_font_a}>已投票</Text>
          </View>
      </View>
    </TouchableOpacity>:
    <TouchableOpacity onPress={()=>_navigator.navigate("VoteDetail",{datas:list})}>
      <View style={styles.list_a}>
          <Image style={styles.list_up} source={{uri:list.pictureUrl}}></Image>
          <View style={styles.list_down}>
              <Text style={styles.list_font}>查看详情</Text>
