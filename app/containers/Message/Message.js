...
import {messages} from '../../services/myDetail';
...
export default class Message extends Component {
  ...
  componentDidMount(){
      messages({page:1},_this.messageList,_this.messageListFail)
  ...
  onEndReached(){
    ...
    if(_state.page*_state.size<_state.total && !_state.load){
      ...
      messages({page:_this.state.page+1},_this.messageList,_this.messageListFail)
    }
  }
